...
Use the logical expression written above to output, for all populations, the allele frequencies of only the SNPs which have an alternate allele frequency greater than 0.05 in the South Asian population. Save the results to a variable called "SAS_SNPs_present_allele_freqs".
...
Use the `summary()` function to get a summary of the alternate allele frequencies for each population. Assign the output to a variable named "SNP_summaries". Hint: You will need to nest another function inside of the `summary()` function.
