  ...
  cases = list(
    ottr::TestCase$new(
      ...
      code = {
        ...
        expect_equal(breast_cancer_data, list(total_patients=9, genes=c("BRCA1", "BRCA2", "PTEN", "TP53"), hospital_pts=list(GGH=3, MHH=5, BSH=1), pt_mutations=patient_mutations))
      }
    )
  )
)