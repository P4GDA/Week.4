...
* Create list with or without names
* Add names to a list
...
Mutations in 4 genes commonly associated with breast cancer are being examined: BRCA1, BRCA2, PTEN, TP53. Create a character vector called "genes" to hold the names of the 4 genes in the order written.
```{r}
